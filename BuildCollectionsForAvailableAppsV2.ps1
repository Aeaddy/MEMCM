...
$SNDIR = 'BOK Available Software'
#$SNDIR = 'BOK Required Software'
...
$uCollAppend = "_A-Uninstall"
$iCOllAppend = "_A-Install"
...
Param ($AppName)
    Get-CMDeviceCollection -Name "*$AppName*_A-Install"
}

Function checkForUninstallCollection{
Param ($AppName)
    Get-CMDeviceCollection -Name "*$AppName*_A-Uninstall"
}
