<#
.SYNOPSIS
	Creates a complete inventory of a Configuration Manager hierarchy using Microsoft Word.
.DESCRIPTION
	Creates a complete inventory of a Configuration Manager hierarchy using Microsoft Word and PowerShell.
...
.EXAMPLE
	PS C:\PSScript > .\DocumentConfigMgr.ps1 -SMSProvider CM1.do.local
	
	Will use all default values.
	HKEY_CURRENT_USER\Software\Microsoft\Office\Common\UserInfo\CompanyName="Adam Eaddy" or
	HKEY_CURRENT_USER\Software\Microsoft\Office\Common\UserInfo\Company="Adam Eaddy"
	$env:username = aeaddy

	Adam Eaddy for the Company Name.
	Motion for the Cover Page format.
	aeaddy for the User Name.
    CM1.do.local for the SMS Provder.
.EXAMPLE
	PS C:\PSScript > .\DocumentConfigMgrR2.ps1 -SMSProvider CM1.do.local -ListAllInformation
	...
	Motion for the Cover Page format.
	aeaddy for the User Name.
    CM1.do.local for the SMS Provider.
    Will give you more information, because of the ListAllInformation switch.
.EXAMPLE
	PS C:\PSScript > .\DocumentConfigMgr.ps1 -SMSProvider CM1.do.local -verbose
...
.EXAMPLE
	PS C:\PSScript > .\DocumentConfigMgr.ps1 -SMSProvider CM1.do.local -CompanyName "Adam's Company" -CoverPage "Motion" -UserName "Adam Eaddy"

	Will use:
		Adam's Company for the Company Name.
		Motion for the Cover Page format.
		Adam Eaddy for the User Name.
        CM1.do.local for the SMS Provider.
.INPUTS
...
.LINK
	http://www.systemcentersupport.org
.NOTES
	NAME: DocumentConfigMgr.ps1
	VERSION: 1.0
	AUTHOR: Adam Eaddy (Former script by David Obrian. (Original former script by Carl Webster! www.carlwebster.com ! with a lot of help from Michael B. Smith and Jeff Wouters))
	LASTEDIT: August, 9, 2017
    REQUIREMENTS: 
                    Local installation of Configuration Managerconsole.
    ...
    Change history:
        ...
        08.09.2017: Updated to work with Office 2016/o365 and Configuration Manager Current Branch.
#>
...
[string]$Title = "Setup and Configuration Report for Configuration Manager Current Branch"
